...
leadslags_bmprison %>%
  ...
  theme(panel.grid.minor = element_blank(), panel.grid.major.x = element_blank()) + ggtitle("Figure 1: The effect decomposition")
```
...
subset(texas_general, statefip == 48 | statefip == random_state[1] | 
  ...
  theme_bw() + ggtitle("Figure 3: Prediction vs Real data by states") +
  xlab("Year") +
