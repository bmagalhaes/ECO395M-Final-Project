...
His preliminar results indicate that an increase in state prison capacity caused an increase in black male incarceration. We used a set of alternative methods to estimate the causal effect. Bearing this in mind, we used a set of alternative methods learned in class to estimate the these counterfactuals.
